  ...
  return (
    <CampaignShell title="Wallet & Payments">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <GlassCard className="border-teal-500/20 shadow-[0_0_40px_-12px_rgba(45,212,191,0.35)]">
          <p className="text-xs text-neutral-500">Circle USDC Wallet</p>
          <p className="mt-2 font-mono text-3xl text-teal-300">4,218.50 USDC</p>
          <p className="mt-1 font-mono text-sm text-neutral-500">0x1a2b…3c4d</p>
          <span className="mt-3 inline-block rounded-full bg-emerald-500/20 px-2 py-0.5 text-xs text-emerald-300">Connected</span>
          <div className="mt-6 flex gap-2">
            <button type="button" className="flex-1 rounded-xl bg-white/10 py-2 text-sm text-white hover:bg-white/15">
              Send USDC
            </button>
            <button type="button" className="flex-1 rounded-xl border border-white/15 py-2 text-sm hover:bg-white/5">
              Receive
            </button>
          </div>
          <ul className="mt-6 space-y-2 border-t border-white/10 pt-4 text-xs text-neutral-400">
        ...
        <GlassCard className="border-blue-500/20 shadow-[0_0_40px_-12px_rgba(59,130,246,0.3)]">
          <p className="text-xs text-neutral-500">Coinbase Wallet</p>
          <button type="button" className="mt-4 w-full rounded-xl border border-[#0052FF]/50 py-3 text-sm text-white hover:bg-[#0052FF]/15">
            Connect Coinbase Wallet
          </button>
          <p className="mt-3 text-xs text-neutral-500">Fund campaigns directly from Coinbase.</p>
          <ul className="mt-4 list-inside list-disc space-y-1 text-xs text-neutral-400">
      ...
      <GlassCard className="mt-8">
        <h3 className="font-serif text-lg text-white">Full transaction history</h3>
