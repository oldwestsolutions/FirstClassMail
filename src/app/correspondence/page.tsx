            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-x-10 lg:gap-y-0">
              <div className="lg:col-span-7">
                ...
                <p className="mt-8 max-w-2xl text-lg leading-relaxed text-neutral-600">
                  ...
                  foundational, not optional add-ons. Where policy and audit matter, we also orient toward{' '}
                  <strong className="font-medium text-neutral-800">checkable proofs</strong>—verifier-efficient ways to gain
                  confidence that routing and rules held—alongside strong <strong className="font-medium text-neutral-800">encryption</strong>{' '}
              ...
              <div className="flex items-end justify-center lg:col-span-5 lg:justify-end">
                <div className="grid w-full max-w-md grid-cols-2 gap-3 sm:max-w-lg">
                  <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
                    <Layers className="h-5 w-5 text-neutral-800" strokeWidth={1.25} />
                    <p className="mt-3 font-serif text-lg text-neutral-900">Checkable proofs</p>
                    <p className="mt-2 text-xs leading-relaxed text-neutral-600">
                      Verifier-efficient integrity—spot-check policy outcomes without replaying every hop by hand.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
                    <Lock className="h-5 w-5 text-neutral-800" strokeWidth={1.25} />
                    <p className="mt-3 font-serif text-lg text-neutral-900">Encryption</p>
                    <p className="mt-2 text-xs leading-relaxed text-neutral-600">
                      Modern TLS to our edge; disciplined access and handling for data at rest.
                    </p>
                  </div>
          ...
          <div className="shell">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-base leading-relaxed text-neutral-600 md:text-lg">
                Checkable proofs and encryption sit beside verified relationships and commercial restraint—concrete controls, not
                slogans.
              </p>
            </div>
                ...
                [
                  {
                    ...
                    body: 'Verifier-efficient proofs—PCP-style spot checks and modern succinct arguments—help audit mail and policy outcomes at scale: gain confidence without naively re-executing every rule on every byte. Roadmaps depend on proof system choice and deployment constraints; the product stance is integrity you can reason about, not “trust us” alone.',
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
              <div>
                ...
                <p className="mt-6 leading-relaxed text-neutral-600">
                  Security here is not a single checkbox. Encryption covers confidentiality on the path and in retention; checkable
                  proof ideas complement that by supporting bounded-work validation of policy outcomes where stakeholders need
                  integrity without everyone reading plaintext. Operational discipline and commercial restraint address insider
                  misuse and pressure to monetize metadata.
                </p>
              </div>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  ...
                  {
                    icon: CheckCircle2,
                    title: 'Integrity under policy',
                    text: 'Verifier-efficient checks align with how sourcing and release rules are enforced—not exhaustive replay by default.',
                  },
                  {
                    icon: Server,
        ...
        <section className="border-b border-neutral-200 bg-white py-20 md:py-28">
          <div className="shell">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-12 overflow-hidden rounded-3xl border border-neutral-200 bg-neutral-50 shadow-sm">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="border-b border-neutral-200 bg-white p-8 md:border-b-0 md:border-r">
